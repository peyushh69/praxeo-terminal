...
`;
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-slate-100 font-mono select-none flex flex-col">
      {/* 1. TOP HEADER NAVIGATION BAR */}
      <div className="border-b border-[#262626] bg-[#0a0a0a] px-4 py-2.5">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0a0a0a] border border-[#262626] hover:border-[#262626] text-slate-300 hover:text-white text-xs tracking-wider transition-all cursor-pointer group shadow-sm"
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-pixel text-xs sm:text-sm text-white tracking-wider flex items-center gap-2">
                  ...
                  <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#0a0a0a]/15 text-white border border-[#262626]/30 font-pixel">
                    KOYFIN-STYLE
                  </span>
                </h1>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-[#0a0a0a] border border-[#262626] hover:border-[#262626] text-slate-300 hover:text-white text-[11px] font-mono flex items-center gap-1.5 transition-all cursor-pointer"
      ...
      <div className="border-b border-[#262626] bg-[#0a0a0a] px-4 py-2">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2.5">
          {/* Index Tabs */}
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 sm:pb-0 scrollbar-none w-full sm:w-auto">
            <span className="text-[10px] font-pixel text-white mr-1 hidden sm:inline flex items-center gap-1">
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-pixel tracking-wider flex items-center gap-1.5 transition-all cursor-pointer whitespace-nowrap ${
                    isActive
                      ? 'bg-neutral-800 text-white font-bold shadow-md shadow-neutral-500/20'
                      : 'bg-[#0a0a0a] text-slate-300 hover:text-white hover:bg-[#0a0a0a] border border-[#262626]'
                  }`}
                ...
                >
                  ...
                  <span
                    className={`px-1.5 py-0.2 rounded text-[8px] font-mono ${
                      isActive ? 'bg-black/25 text-black font-bold' : 'bg-[#0a0a0a] text-slate-400'
                    }`}
                  >
                    {bm.count}
                  </span>
            ...
            <div className="relative">
              <select
                ...
                className="bg-[#0a0a0a] text-slate-300 hover:text-white border border-[#262626] rounded-lg px-2.5 py-1.5 text-xs font-pixel tracking-wider cursor-pointer focus:outline-none focus:border-[#262626]"
              >
          ...
          <div className="hidden md:flex items-center gap-2 text-[10px] text-slate-400 font-mono bg-[#0a0a0a] px-2.5 py-1 rounded border border-[#262626]">
            <span className="text-white font-pixel">BENCHMARK:</span>
      ...
      <div className="border-b border-[#262626] bg-[#0a0a0a] px-4 py-2.5">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {/* Y-Axis Selector */}
            <div className="flex items-center gap-1.5 bg-[#0a0a0a] border border-[#262626] rounded-lg px-2.5 py-1 text-xs relative">
              <span className="text-[10px] font-pixel text-white">Y-AXIS (SHORT):</span>
              <button
                type="button"
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="font-bold text-white flex items-center gap-1 hover:text-white cursor-pointer"
              >
              ...
              {showYDropdown && (
                <div
                  ...
                  className="absolute top-full left-0 mt-1 w-44 bg-[#0a0a0a] border border-[#262626] rounded-lg shadow-xl z-50 py-1"
                >
                  {TIMEFRAME_OPTIONS.map((opt) => (
                    <button
                      ...
                      className={`w-full px-3 py-1.5 text-left text-xs font-mono flex items-center justify-between hover:bg-[#0a0a0a] ${
                        yTimeframe === opt.id ? 'text-white font-bold bg-[#0a0a0a]' : 'text-slate-300'
                      }`}
                    >
                      <span>{opt.label}</span>
                      {yTimeframe === opt.id && <Check className="w-3.5 h-3.5 text-white" />}
                    </button>
                  ))}
                </div>
              )}
            ...
            {/* X-Axis Selector */}
            <div className="flex items-center gap-1.5 bg-[#0a0a0a] border border-[#262626] rounded-lg px-2.5 py-1 text-xs relative">
              <span className="text-[10px] font-pixel text-white">X-AXIS (LONG):</span>
              <button
                type="button"
                onClick={(e) => {
                  e.stopPropagation();
                ...
                >
                  {TIMEFRAME_OPTIONS.map((opt) => (
                    <button
                      ...
                      className={`w-full px-3 py-1.5 text-left text-xs font-mono flex items-center justify-between hover:bg-[#0a0a0a] ${
                        xTimeframe === opt.id ? 'text-white font-bold bg-[#0a0a0a]' : 'text-slate-300'
                      }`}
                    >
                      <span>{opt.label}</span>
                      {xTimeframe === opt.id && <Check className="w-3.5 h-3.5 text-white" />}
                    </button>
                  ))}
                </div>
              )}
            ...
            <div className="hidden lg:flex items-center gap-2 text-[11px] bg-[#0a0a0a] px-3 py-1 rounded-lg border border-[#262626] text-slate-400">
              ...
              <span className="text-slate-300">
                ...
                <strong className={benchmarkX >= 0 ? 'text-white' : 'text-neutral-500'}>
                  {benchmarkX >= 0 ? '+' : ''}
              ...
              <span className="text-slate-300">
                ...
                <strong className={benchmarkY >= 0 ? 'text-white' : 'text-neutral-500'}>
                  {benchmarkY >= 0 ? '+' : ''}
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
            ...
            <div className="relative">
              <select
                ...
                className="bg-[#0a0a0a] border border-[#262626] rounded-lg px-2.5 py-1 text-xs text-slate-200 focus:outline-none focus:border-[#262626] cursor-pointer"
              >
                {sectorsList.map((sec) => (
                  <option key={sec} value={sec} className="bg-[#0a0a0a] text-slate-200">
            ...
            <div className="relative flex-1 sm:w-36">
              ...
              <input
                ...
                className="w-full bg-[#0a0a0a] border border-[#262626] rounded-lg pl-7 pr-2 py-1 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-[#262626]"
              />
            </div>
            ...
            <button
              ...
              className={`px-2 py-1 rounded text-[10px] font-pixel border transition-all cursor-pointer ${
                showLabels
                  ? 'bg-[#0a0a0a]/20 text-white border-[#262626]/50'
                  : 'bg-[#0a0a0a] text-slate-500 border-[#262626]'
              }`}
            ...
            <button
              ...
              className={`px-2 py-1 rounded text-[10px] font-pixel border transition-all cursor-pointer ${
                colorMode === 'quadrant'
                  ? 'bg-[#0a0a0a]/20 text-white border-[#262626]/50'
                  : 'bg-[#0a0a0a] text-white border-[#262626]/40'
              }`}
      ...
      <div className="max-w-7xl mx-auto w-full px-3 sm:px-6 py-4 flex-1 flex flex-col space-y-4">
        ...
        {error && (
          <div className="p-4 rounded-xl bg-[#0a0a0a] border border-rose-800 text-rose-200 text-xs flex items-center justify-between">
            <span>{error}</span>
            <button
              onClick={() => fetchData(selectedIndexId, true)}
        ...
        {data && (
          <div className="bg-[#0a0a0a] border border-[#262626] rounded-xl p-3 sm:p-4 shadow-2xl relative flex flex-col">
            {/* Chart Top Header (Title + Linear Regression Formula in top right corner) */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pb-2 border-b border-[#262626] mb-2 px-1">
              <div className="flex items-center justify-between gap-2 min-w-0">
                <div className="flex items-center gap-2 min-w-0">
                  <Sliders className="w-4 h-4 text-white flex-shrink-0" />
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 bg-[#0a0a0a] px-2.5 py-1 rounded border border-[#262626] text-[10px] sm:text-[11px]">
                <span className="text-slate-300 font-mono font-bold tracking-wider">
                  {regression.equation}
                </span>
                <span className="text-slate-600 hidden xs:inline">|</span>
                <span className="font-mono text-slate-300">
                  R² = <strong className="text-white">{regression.rSquared.toFixed(4)}</strong>
                </span>
                <span className="text-slate-600 hidden xs:inline">|</span>
                <span className="font-mono text-slate-300">
                  r = <strong className="text-white">{regression.correlation.toFixed(3)}</strong>
                </span>
              </div>
            </div>
            ...
            {isMobile && (
              <div className="flex items-center justify-between pb-2 mb-2 border-b border-[#262626] text-[9px] font-pixel">
            ...
            {isMobile && mobileMode === 'pan' && (
              <div className="text-[9px] font-mono text-white pb-1 text-center animate-pulse">
            ...
            <div
              ref={containerRef}
              className={`w-full relative select-none bg-[#0a0a0a] rounded-lg border border-[#262626] ${
            ...
            >
              ...
              >
                <defs>
                  ...
                  <linearGradient id="cyanDotGlow" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#ff8800" stopOpacity="0.95" />
                ...
                <text
                  ...
                  textAnchor="end"
                  className={`font-pixel ${isMobile ? 'text-[7.5px]' : 'text-[9px]'} fill-white/60 select-none pointer-events-none tracking-wider font-bold`}
                >
                ...
                <text
                  ...
                  y={padding.top + (isMobile ? 16 : 22)}
                  textAnchor="start"
                  className={`font-pixel ${isMobile ? 'text-[7.5px]' : 'text-[9px]'} fill-neutral-300/60 select-none pointer-events-none tracking-wider font-bold`}
                >
                ...
                <text
                  ...
                  textAnchor="end"
                  className={`font-pixel ${isMobile ? 'text-[7.5px]' : 'text-[9px]'} fill-neutral-400/60 select-none pointer-events-none tracking-wider font-bold`}
                >
                ...
                <text
                  ...
                  y={padding.top + plotHeight - (isMobile ? 8 : 12)}
                  textAnchor="start"
                  className={`font-pixel ${isMobile ? 'text-[7.5px]' : 'text-[9px]'} fill-neutral-500/60 select-none pointer-events-none tracking-wider font-bold`}
                >
                    ...
                    return (
                      <g>
                        ...
                        <text
                          ...
                          textAnchor="middle"
                          className={`font-pixel ${isMobile ? 'text-[7px]' : 'text-[8px]'} fill-white font-bold`}
                        >
                    ...
                    return (
                      <g>
                        ...
                        <text
                          ...
                          textAnchor="middle"
                          className={`font-pixel ${isMobile ? 'text-[6.5px]' : 'text-[8px]'} fill-white font-bold`}
                        >
              ...
              {hoveredPoint && !selectedPoint && (
                <div
                  className="absolute z-50 pointer-events-none bg-[#0a0a0a]/95 border border-[#262626] rounded-xl p-3 shadow-2xl backdrop-blur-md min-w-[240px] text-left transform -translate-x-1/2 -translate-y-full mb-3"
                  style={{
                ...
                >
                  ...
                  <div className="space-y-1.5 text-[11px] font-mono">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`font-bold ${
                          hoveredPoint.yReturn >= 0 ? 'text-white' : 'text-neutral-500'
                        }`}
                      >
                    ...
                    <div className="flex items-center justify-between text-[10px] text-slate-500">
                      ...
                      <span
                        className={hoveredPoint.yAlpha >= 0 ? 'text-emerald-400' : 'text-rose-400'}
                      >
                    ...
                    <div className="h-px bg-[#0a0a0a] my-1" />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`font-bold ${
                          hoveredPoint.xReturn >= 0 ? 'text-white' : 'text-neutral-500'
                        }`}
                      >
                    ...
                    <div className="flex items-center justify-between text-[10px] text-slate-500">
                      ...
                      <span
                        className={hoveredPoint.xAlpha >= 0 ? 'text-emerald-400' : 'text-rose-400'}
                      >
                    ...
                    <div className="flex items-center justify-between text-[10px]">
                      ...
                      <span
                        className={`font-bold ${
                          hoveredPoint.weightedContribY >= 0 ? 'text-white' : 'text-neutral-500'
                        }`}
                      >
            ...
            {selectedPoint && (
              <div className="mt-3 bg-[#0a0a0a] border border-[#262626] rounded-xl p-3 shadow-2xl relative">
                <button
                  onClick={() => setSelectedPoint(null)}
                  className="absolute top-2.5 right-2.5 p-1 rounded bg-[#0a0a0a] text-slate-400 hover:text-white border border-[#262626] cursor-pointer"
                  title="Close inspector"
                >
                  <X className="w-3.5 h-3.5" />
                </button>

                <div className="flex items-center gap-2 pb-2 border-b border-[#262626] mb-2 pr-7">
                  <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[10px] font-mono">
                  <div className="bg-[#0a0a0a] p-2 rounded border border-[#262626]">
                    ...
                    <div className={`font-bold text-sm ${selectedPoint.yReturn >= 0 ? 'text-white' : 'text-neutral-500'}`}>
                      {selectedPoint.yReturn >= 0 ? '+' : ''}{selectedPoint.yReturn.toFixed(2)}%
                    </div>
                    <div className={`text-[8.5px] ${selectedPoint.yAlpha >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                  ...
                  <div className="bg-[#0a0a0a] p-2 rounded border border-[#262626]">
                    ...
                    <div className={`font-bold text-sm ${selectedPoint.xReturn >= 0 ? 'text-white' : 'text-neutral-500'}`}>
                      {selectedPoint.xReturn >= 0 ? '+' : ''}{selectedPoint.xReturn.toFixed(2)}%
                    </div>
                    <div className={`text-[8.5px] ${selectedPoint.xAlpha >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                  ...
                  <div className="bg-[#0a0a0a] p-2 rounded border border-[#262626]">
                    ...
                    <div
                      className={`font-bold text-sm ${
                        selectedPoint.weightedContribY >= 0 ? 'text-white' : 'text-neutral-500'
                      }`}
                    >
                      {selectedPoint.weightedContribY >= 0 ? '+' : ''}
                      {selectedPoint.weightedContribY.toFixed(1)} pts
                    </div>
                    <div className="text-[8.5px] text-white">{selectedPoint.weight.toFixed(2)}% wt</div>
                  </div>
                </div>
              </div>
            )}
        ...
        {data && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-[#0a0a0a] border border-[#262626] rounded-xl p-4 shadow-lg flex flex-col justify-between space-y-3">
              <div className="flex items-center justify-between">
              ...
              <div>
                  ...
                  <span
                    className={`text-xs font-mono font-bold px-1.5 py-0.5 rounded ${
                      stats.beatingXCount >= 25
                        ? 'bg-neutral-900 text-white border border-emerald-800'
                        : 'bg-neutral-900 text-neutral-400 border border-amber-800'
                    }`}
                  >
                ...
                <p className="text-xs text-slate-300 font-mono mt-1.5 leading-relaxed">
                  ...
                  <strong className="text-white">{currentXOption.label}</strong> horizon (
              ...
              <div className="grid grid-cols-4 gap-1.5 pt-2 border-t border-[#262626] text-center text-[10px]">
                <div className="bg-[#0a0a0a] border border-emerald-900/40 rounded p-1">
                  <div className="text-white font-bold">{stats.leadersCount}</div>
                  <div className="text-[8px] text-slate-500 font-pixel">LEADERS</div>
                </div>
                <div className="bg-[#0a0a0a] border border-sky-900/40 rounded p-1">
                  <div className="text-neutral-300 font-bold">{stats.reversalsCount}</div>
                  <div className="text-[8px] text-slate-500 font-pixel">REVERSAL</div>
                </div>
                <div className="bg-[#0a0a0a] border border-amber-900/40 rounded p-1">
                  <div className="text-neutral-400 font-bold">{stats.pullbacksCount}</div>
                  <div className="text-[8px] text-slate-500 font-pixel">PULLBACK</div>
                </div>
                <div className="bg-[#0a0a0a] border border-rose-900/40 rounded p-1">
                  <div className="text-neutral-500 font-bold">{stats.laggardsCount}</div>
            ...
            <div className="bg-[#0a0a0a] border border-[#262626] rounded-xl p-4 shadow-lg flex flex-col justify-between space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-pixel text-[10px] text-white tracking-wider">
              ...
              <div className="space-y-2">
                {drivers.map((d, i) => (
                  <div
                    key={d.symbol}
                    className="flex items-center justify-between p-2 rounded-lg bg-[#0a0a0a] border border-neutral-900 hover:border-emerald-700/50 transition-colors"
                  >
                    <div className="flex items-center gap-2">
                      <span className="font-pixel text-[9px] text-neutral-700">#{i + 1}</span>
                      <div>
            ...
            <div className="bg-[#0a0a0a] border border-[#262626] rounded-xl p-4 shadow-lg flex flex-col justify-between space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-pixel text-[10px] text-neutral-500 tracking-wider">
              ...
              <div className="space-y-2">
                {drags.map((d, i) => (
                  <div
                    key={d.symbol}
                    className="flex items-center justify-between p-2 rounded-lg bg-[#0a0a0a] border border-neutral-900 hover:border-rose-700/50 transition-colors"
                  >
                    <div className="flex items-center gap-2">
                      <span className="font-pixel text-[9px] text-neutral-700">#{i + 1}</span>
                      <div>
        ...
        {data && (
          <div className="bg-[#0a0a0a] border border-[#262626] rounded-xl p-4 shadow-lg mt-2">
            <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-[#262626] mb-3">
              <div className="flex items-center gap-2">
            ...
            <div className="overflow-x-auto max-h-[380px] overflow-y-auto">
              <table className="w-full text-left text-xs font-mono">
                <thead className="sticky top-0 bg-[#0a0a0a] text-slate-400 border-b border-[#262626] text-[10px] font-pixel">
                  <tr>
                ...
                <tbody className="divide-y divide-[#101420]">
                  {displayedPoints.map((p) => {
                    ...
                    return (
                      ...
                      >
                        <td className="py-2 px-3 font-bold text-white group-hover:text-white">
                          {p.symbol}
                        </td>
                        ...
                        <td
                          className={`py-2 px-3 text-right font-bold ${
                            p.xReturn >= 0 ? 'text-white' : 'text-neutral-500'
                          }`}
                        >
                          {p.xReturn >= 0 ? '+' : ''}
                          {p.xReturn.toFixed(2)}%
                        ...
                        <td
                          className={`py-2 px-3 text-right font-bold ${
                            p.yReturn >= 0 ? 'text-white' : 'text-neutral-500'
                          }`}
                        >
                          {p.yReturn >= 0 ? '+' : ''}
                          {p.yReturn.toFixed(2)}%
                        ...
                        <td
                          className={`py-2 px-3 text-right font-bold ${
                            p.yAlpha >= 0 ? 'text-emerald-400' : 'text-rose-400'
                          }`}
                        >
                          {p.yAlpha >= 0 ? '+' : ''}
                          {p.yAlpha.toFixed(2)}%
      ...
      {showScriptModal && (
        ...
        >
          <div
            className="bg-[#0a0a0a] border border-[#262626] rounded-xl max-w-2xl w-full p-5 shadow-2xl space-y-4 text-left font-mono"
            onClick={(e) => e.stopPropagation()}
          >
            ...
            <div className="relative">
              <pre className="bg-[#0a0a0a] border border-[#262626] rounded-lg p-3 text-[11px] text-white overflow-x-auto max-h-72 font-mono">
                {pythonScriptContent}
              </pre>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#262626]">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-neutral-800 text-white font-pixel text-[9px] font-bold hover:bg-[#0a0a0a] transition-all cursor-pointer flex items-center gap-1.5"
              >
