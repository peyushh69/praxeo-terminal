    ...
    <div className="praxis-card p-4 sm:p-5 shadow-2xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#262626]">
        <div className="flex items-center gap-2.5">
          <div className="p-2 bg-[#0a0a0a]/10 border border-[#262626]/40 text-white rounded-lg">
        ...
        {/* Tab switcher */}
        <div className="flex items-center bg-[#0a0a0a] border border-[#262626] p-1 rounded-xl self-start sm:self-auto font-pixel text-[10px] overflow-x-auto scrollbar-none max-w-full">
          <button
            id="tab-hud-radar"
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
              ...
              <div className="lg:col-span-3 space-y-2.5">
                <div className="praxis-card p-3">
                  <div className="text-[9px] text-white font-pixel uppercase mb-1">
                    9 EMA MOMENTUM
                  </div>
                  <div className="text-2xl font-pixel text-white">
                    {summary.aboveEma9.percentage}%
                  </div>
                  <div className="text-[10px] text-white font-pixel mt-1">
                    {summary.aboveEma9.count} / 50 OVER 9 EMA
                  </div>
                  <div className="w-full bg-[#0a0a0a] h-1.5 mt-2 rounded-full border border-[#262626] overflow-hidden">
                    <div className="h-full bg-emerald-500" style={{ width: `${summary.aboveEma9.percentage}%` }}></div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-6 flex flex-col items-center justify-center p-6 praxis-card relative overflow-hidden">
                <div className="absolute w-72 h-72 rounded-full border border-dashed border-[#262626] pointer-events-none"></div>
                <div className="absolute w-56 h-56 rounded-full border border-[#262626] pointer-events-none"></div>
                <div className="absolute w-40 h-40 rounded-full border border-[#262626] pointer-events-none"></div>
                
                {/* HUD Crosshairs */}
                <div className="absolute w-full h-[1px] bg-[#0a0a0a]"></div>
                <div className="absolute h-full w-[1px] bg-[#0a0a0a]"></div>

                {/* Central Radar Circle */}
                <div className="relative z-10 w-48 h-48 sm:w-56 sm:h-56 rounded-full bg-[#0a0a0a] border-2 border-[#262626] flex flex-col items-center justify-center ">
                  <div className="text-[9px] tracking-widest text-white font-pixel uppercase">
                    COMPOSITE BREADTH
                  </div>
                  <div className="text-4xl sm:text-5xl font-pixel text-white my-2 tracking-tight">
                    {summary.aboveEma9.percentage}%
                  </div>
                  <div className="text-[10px] px-2 py-0.5 bg-neutral-800 text-white font-pixel font-bold rounded">
              ...
              <div className="lg:col-span-3 space-y-2.5">
                <div className="praxis-card p-3">
                  ...
                  <div className="w-full bg-[#0a0a0a] h-1.5 mt-2 rounded-full border border-[#262626] overflow-hidden">
                    <div className="h-full bg-neutral-700" style={{ width: `${summary.aboveEma50.percentage}%` }}></div>
                  </div>
                </div>
                ...
                <div className="praxis-card p-3">
                  <div className="text-[9px] text-neutral-400 font-pixel uppercase mb-1">
                    MACD BULLISH CROSS
                  </div>
                  ...
                  <div className="w-full bg-[#0a0a0a] h-1.5 mt-2 rounded-full border border-[#262626] overflow-hidden">
                    <div className="h-full bg-neutral-700" style={{ width: `${summary.macdBullish.percentage}%` }}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="praxis-card p-3 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-2 font-mono">
              <div className="flex items-center gap-2">
                <span className="text-white font-pixel text-[10px]">[QUANT DIAGNOSIS]</span>
                <span className="text-slate-300">
                  {summary.marketStanceReason}
                </span>
              </div>
              <div className="text-slate-400 font-pixel text-[10px] shrink-0">
                GOLDEN STACKS: <strong className="text-neutral-400">{summary.goldenStackCount}</strong> | GOLDEN CROSSES: <strong className="text-purple-400">{summary.goldenCrossCount}</strong>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'trend-series' && (
          <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
              ...
              <div className="flex items-center gap-1.5 bg-[#0a0a0a] p-1 border border-[#262626] rounded-lg font-pixel text-[9px]">
                  ...
                  <Tooltip
                    content={({ active, payload, label }) => {
                      if (active && payload && payload.length) {
                        return (
                          <div className="p-3 bg-[#0a0a0a] text-white border border-[#262626] rounded-xl shadow-2xl text-xs space-y-1 font-mono">
                            <div className="font-pixel text-[10px] text-emerald-400 pb-1 border-b border-[#262626]">
                              DATE: {label}
                            </div>
                  ...
                  <Tooltip
                    content={({ active, payload }) => {
                      if (active && payload && payload.length) {
                        ...
                        return (
                          <div className="p-3 bg-[#0a0a0a] text-white border border-[#262626] rounded-xl shadow-2xl text-xs space-y-1 font-mono">
                            <div className="font-pixel text-xs text-white">{d.name} &bull; {d.tag}</div>
                            <div className="text-slate-300 text-[11px]">{d.description}</div>
                            <div className="pt-1.5 border-t border-[#262626] flex justify-between gap-4 font-mono">
                  ...
                  <Tooltip
                    content={({ active, payload }) => {
                      if (active && payload && payload.length) {
                        const d = payload[0].payload;
                        return (
                          <div className="p-3 bg-[#0a0a0a] text-white border border-[#262626] rounded-xl shadow-2xl text-xs space-y-1.5 font-mono">
                            <div className="font-pixel text-xs text-white">{d.sector} ({d.total} Stocks)</div>
                            <div className="grid grid-cols-2 gap-x-4 gap-y-1 pt-1 border-t border-[#262626]">
                              <span className="text-emerald-400">&gt; EMA 9:</span>
                              ...
                              <span className="text-white">&gt; EMA 50:</span>
                              <span className="font-bold text-white">{d.above50}%</span>
                              ...
                              <span className="text-neutral-400">MACD Bull:</span>
                              <span className="font-bold text-neutral-400">{d.macdBullish}%</span>
                            </div>
                            <div className="pt-1 text-[10px] text-slate-400 border-t border-[#262626]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 pt-2">
              {sectorBreadth.map((s, idx) => (
                <div
                  ...
                  className="praxis-card p-3 hover:border-[#262626] cursor-pointer transition-all text-xs font-mono"
                >
                  <div className="flex items-center justify-between text-[9px] text-slate-500 font-pixel">
                    <span>RANK #{idx + 1}</span>
                    <span className="text-white">{s.totalStocks} STOCKS</span>
                  </div>
